  ...
  def create
    ...
    respond_to do |format|
      if @declared_program.save
        format.html { redirect_to @declared_program, notice: 'Declared program was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @declared_program.update(declared_program_params)
        format.html { redirect_to @declared_program, notice: 'Declared program was successfully updated.' }
