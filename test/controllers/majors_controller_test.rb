...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { requirements_id: @major.requirements_id, title: @major.title } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { requirements_id: @major.requirements_id, title: @major.title } }
